...
const { parseOrgMode, Source, Results, Headline, SimpleMarkup, Fragment, } = window.Org;
const { orgDoc, getCodeItems, blockSource, blockOrg: docBlockOrg, ParsedCodeBlock, parseYaml, } = window.DocOrg;
const { last, DataStore, DataStoreEditingOptions, blockText, posFor, escapeHtml, copyBlock, LeisureEditCore, set$, } = window.LeisureEditCore;
var orgEditing = null;
