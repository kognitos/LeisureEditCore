...
(function() {
  ...
  define(['./org', 'js-yaml', 'lazy'], function(Org, Yaml, Lazy) {
    ...
    ({Headline, Source, HTML, Keyword, Drawer, Meat, UnknownDeclaration, Results, parseOrgMode, Fragment} = Org);
    ({safeLoad, load, dump} = Yaml);
    ({
      _: _L
    } = Lazy);
    ParsedCodeBlock = class ParsedCodeBlock {
      constructor(block) {
    ...
    return {getCodeItems, isCodeBlock, createDocFromOrg, checkSingleNode, orgDoc, docRoot, linkDocs, isYaml, isText, crnl, lineCodeBlockType, blockSource, ParsedCodeBlock, blockOrg, parseYaml};
  });
